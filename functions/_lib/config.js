...
function normalizeConfig(input) {
  ...
  return {
    ...
    SLACK_CODEX_DISPATCH_TOKEN: normalizeValue(source.SLACK_CODEX_DISPATCH_TOKEN, 300),
    ...
    SLACK_ACTOR_PROBE_COOLDOWN_MS: normalizeValue(source.SLACK_ACTOR_PROBE_COOLDOWN_MS, 40)
  };
}
...
function mergeConfig(stored, env) {
  ...
  return normalizeConfig({
    ...
    SLACK_CODEX_DISPATCH_TOKEN: env?.SLACK_CODEX_DISPATCH_TOKEN || base.SLACK_CODEX_DISPATCH_TOKEN,
    ...
    SLACK_ACTOR_PROBE_COOLDOWN_MS: env?.SLACK_ACTOR_PROBE_COOLDOWN_MS || base.SLACK_ACTOR_PROBE_COOLDOWN_MS
  });
}
...
export function describeConfig(config) {
  ...
  return {
    ...
    SLACK_CODEX_DISPATCH_TOKEN: mask(normalized.SLACK_CODEX_DISPATCH_TOKEN),
    ...
    SLACK_ACTOR_PROBE_COOLDOWN_MS: normalized.SLACK_ACTOR_PROBE_COOLDOWN_MS || ""
  };
}
